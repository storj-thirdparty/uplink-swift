...
extension Storj {
    ...
    func loadAccessSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        do {
            ...
            var sym = dlsym(dynammicFileHandle, "request_access_with_passphrase")
            if sym == nil {
            ...
            sym = dlsym(dynammicFileHandle, "free_access_result")
            if sym == nil {
            ...
            //
            // Parse Access
            sym = dlsym(dynammicFileHandle, "parse_access")
            if sym == nil {
            ...
            //
            // Access Serialize
            sym = dlsym(dynammicFileHandle, "access_serialize")
            if sym == nil {
            ...
            //
            //
            sym = dlsym(dynammicFileHandle, "access_share")
            if sym == nil {
            ...
            //
            //
            sym = dlsym(dynammicFileHandle, "free_string_result")
            if sym == nil {
            ...
            //
            //
            sym = dlsym(dynammicFileHandle, "config_request_access_with_passphrase")
            if sym == nil {
    ...
    func loadProjectSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        var sym = dlsym(dynammicFileHandle, "open_project")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "close_project")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_project_result")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "config_open_project")
        if sym != nil {
    ...
    func loadBucketSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        //
        var sym = dlsym(dynammicFileHandle, "stat_bucket")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "create_bucket")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "ensure_bucket")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "delete_bucket")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_bucket")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_bucket_result")
        if sym != nil {
    ...
    func loadBucketListSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        var sym = dlsym(dynammicFileHandle, "list_buckets")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "bucket_iterator_next")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "bucket_iterator_item")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "bucket_iterator_err")
        if sym != nil {
        ...
        sym = dlsym(dynammicFileHandle, "free_bucket_iterator")
        if sym != nil {
    ...
    func loadObjectSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        //
        var sym = dlsym(dynammicFileHandle, "stat_object")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "delete_object")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_object_result")
        if sym != nil {
    ...
    func loadObjectListSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        var sym = dlsym(dynammicFileHandle, "free_object")
        if sym != nil {
        ...
        sym = dlsym(dynammicFileHandle, "list_objects")
        if sym != nil {
        ...
        sym = dlsym(dynammicFileHandle, "object_iterator_next")
        if sym != nil {
        ...
        sym = dlsym(dynammicFileHandle, "object_iterator_err")
        if sym != nil {
        ...
        sym = dlsym(dynammicFileHandle, "object_iterator_item")
        if sym != nil {
        ...
        sym = dlsym(dynammicFileHandle, "free_object_iterator")
        if sym != nil {
    ...
    func loadUploadSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        var sym = dlsym(dynammicFileHandle, "upload_object")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "upload_write")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "upload_commit")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "upload_abort")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "upload_set_custom_metadata")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_write_result")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_upload_result")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "upload_info")
        if sym != nil {
    ...
    func loadDownloadSym(dynammicFileHandle: UnsafeMutableRawPointer?) throws {
        var sym = dlsym(dynammicFileHandle, "download_object")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "download_read")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_download_result")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "download_info")
        if sym != nil {
        ...
        //
        sym = dlsym(dynammicFileHandle, "free_read_result")
        if sym != nil {
        ...
        sym = dlsym(dynammicFileHandle, "close_download")
        if sym != nil {
