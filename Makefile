...
build:
	...
	if test ! -d $(CLIBUPLINK_INCLUDE_FOLDER_NAME); then mkdir -p $(CLIBUPLINK_INCLUDE_FOLDER_NAME); fi
	if test ! -d $(UPLINKC_NAME); then git clone --depth 1 --branch v1.8.0 https://github.com/storj/uplink-c; fi
